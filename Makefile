...
LDLOADLIBS = -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -lgdk_pixbuf-2.0 -lcairo-gobject -lcairo -lgobject-2.0 -lglib-2.0 -lgthread-2.0
BSLOADLIBS = 
LD_RUN_PATH = /usr/lib:/usr/lib/../lib64
...
PASTHRU = LIBPERL_A="$(LIBPERL_A)"\
	...
	PASTHRU_INC='-pthread -I/usr/include/gtk-3.0 -I/usr/include/gio-unix-2.0/ -I/usr/include/libxkbcommon -I/usr/include/wayland -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/harfbuzz -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libdrm -I/usr/include/libpng16 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/at-spi2-atk/2.0 -I/usr/include/at-spi-2.0 -I/usr/include/dbus-1.0 -I/usr/lib64/dbus-1.0/include -I/usr/include/atk-1.0 -I/home/pl/perl5/lib/perl5/x86_64-linux-thread-multi/Glib/Install -I. $(PASTHRU_INC)'
...
$(INST_STATIC): $(OBJECT) $(MYEXTLIB) $(INST_ARCHAUTODIR)$(DFSEP).exists
	$(RM_F) "$@"
	$(NOECHO) $(ECHO) [ AR $@ ]
	$(NOECHO) $(FULL_AR) $(AR_STATIC_ARGS) "$@" $(OBJECT)
	$(RANLIB) "$@"
	$(CHMOD) $(PERM_RWX) $@
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *perl.core MYMETA.json \
	  MYMETA.yml WebKit.base \
	  WebKit.bs WebKit.bso \
	  WebKit.c WebKit.def \
	  WebKit.exp WebKit.o \
	  WebKit_def.old blibdirs.ts \
	  core core.*perl.*.? \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  ExtUtils::Depends: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Gtk3::WebKit: '\''0.02'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "ExtUtils::Depends" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "ExtUtils::MakeMaker" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "ExtUtils::PkgConfig" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Glib::MakeHelper" : "0"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Gtk3::WebKit" : "0.02",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Moose" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Time::HiRes" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "X11::Xlib" : "0"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
